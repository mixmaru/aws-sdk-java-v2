...
public class Http1TunnelConnectionPool implements ChannelPool {
    ...
    private final Set<ProxyConfiguration.CredentialProvider> credentialProviders;
    ...
    public Http1TunnelConnectionPool(EventLoop eventLoop, ChannelPool delegate, SslContext sslContext,
                                     URI proxyAddress, String proxyUsername, String proxyPassword, Set<ProxyConfiguration.CredentialProvider> credentialProviders,
                                     URI remoteAddress, ChannelPoolHandler handler, NettyConfiguration nettyConfiguration) {
        this(eventLoop, delegate, sslContext,
             proxyAddress, proxyUsername, proxyPassword, credentialProviders, remoteAddress, handler,
    ...
    Http1TunnelConnectionPool(EventLoop eventLoop, ChannelPool delegate, SslContext sslContext,
                              URI proxyAddress, String proxyUser, String proxyPassword, Set<ProxyConfiguration.CredentialProvider> credentialProviders, URI remoteAddress,
    ...
    private void setupChannel(Channel ch, Promise<Channel> acquirePromise) {
        ...
        ch.pipeline().addLast(initHandlerSupplier.newInitHandler(delegate, proxyUser, proxyPassword, credentialProviders, remoteAddress,
    ...
    interface InitHandlerSupplier {
        ChannelHandler newInitHandler(ChannelPool sourcePool, String proxyUsername, String proxyPassword, Set<ProxyConfiguration.CredentialProvider> credentialProviders, URI remoteAddress,
